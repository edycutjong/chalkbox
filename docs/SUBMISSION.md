...
| **Benchmark Proof** — reproducible p50/p95 | ✅ | `scripts/bench.ts` — 20-prompt suite, p50/p95 + success rate + verification catch rate |
| **Test Count** — exact count in README | ✅ | Target 100+ (loop unit + harness/invariant + 15 committed smoke tests); count stated in README |
