...
export const GALLERY_SIMS: GallerySim[] = [
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "7.NS.A.1",
      text: "Add/subtract rational numbers on a number line",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "6.RP.A.3",
      text: "Reason about ratios with tables & double number lines",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "8.EE.B.5",
      text: "Graph proportional relationships; interpret slope",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "4.NF.A.1",
      text: "Recognize/generate equivalent fractions",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "8.G.B.7",
      text: "Apply the Pythagorean theorem to find side lengths",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "6.SP.A.3",
      text: "A measure of center summarizes data with one number",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "8.F.A.1",
      text: "Understand a function as one output per input",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "7.SP.C.6",
      text: "Approximate probability from long-run frequency",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "CCSS",
      code: "3.MD.C.7c",
      text: "Area models and the distributive property",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "NGSS",
      code: "HS-PS2-1",
      text: "Newton's 2nd law: net force, mass, acceleration",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "NGSS",
      code: "HS-PS2-1",
      text: "Analyze force/mass/acceleration relationships",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "NGSS",
      code: "MS-PS4-1",
      text: "Mathematical model of a wave's properties",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "NGSS",
      code: "MS-PS2-2",
      text: "Change in motion depends on net force and mass",
    },
  ...
  },
  {
    ...
    standard: {
      framework: "NGSS",
      code: "MS-PS3-1",
      text: "Kinetic energy relates to mass and speed",
    },
...
/**
 * Resolve an accepted teacher prompt to a manipulative we ACTUALLY have a live,
 * interactive renderer for. In this skeleton that is only the flagship
 * (fraction-division-bars). Returns null for any in-scope prompt we cannot yet
 * render — the Create UI then shows an honest "coming soon" state instead of
 * rendering a manipulative that does not match the prompt's subject.
 *
 * This is deliberately narrow and honest: it matches the flagship's own
 * fraction-division idea and nothing else, so we never claim to have built a
 * physics sim (or any other math sim) that this demo does not ship.
 */
export function resolveInteractiveSim(prompt: string, subject: Subject | null): GallerySim | null {
  const flagship = GALLERY_SIMS.find((s) => s.interactive);
  if (!flagship) return null;
  const p = prompt.toLowerCase();
  const isFractionDivision =
    subject === "math" && p.includes("fraction") && (p.includes("divid") || p.includes("bigger"));
  return isFractionDivision ? flagship : null;
}
